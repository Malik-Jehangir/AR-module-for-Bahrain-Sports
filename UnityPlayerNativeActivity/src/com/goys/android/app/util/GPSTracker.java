...
public class GPSTracker extends Service implements LocationListener {
	...
	public Location getLocation() {
		try {
			...
			GoysLog.d("GPSTracker", "isGPSEnabled " + isGPSEnabled);
			GoysLog.d("GPSTracker", "isNetworkEnabled " + isNetworkEnabled);
	...
	public void showSettingsAlert() {
		 ...
		 * 
		 * // on pressing cancel button alertDialog.setNegativeButton("Cancel",
		 ...
		 */
		CommonActions.showErrorAlertDialog(mContext, 0, mContext.getResources()
