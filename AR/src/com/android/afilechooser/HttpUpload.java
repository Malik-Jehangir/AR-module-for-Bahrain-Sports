...
import com.android.afilechooser.MyMultipartEntity.ProgressListener;
...
public class HttpUpload extends AsyncTask<Void, Integer, Void> {
	...
	private static final String url = "http://192.168.133.112:448/FileUpload/index.php";
	...
	protected Void doInBackground(Void... params) {
		try {
			...
			if (statusCode == HttpStatus.SC_OK) {
				...
				GoysLog.d("DEBUG", fullRes);

			} else {
				GoysLog.d("DEBUG", "HTTP Fail, Response Code: " + statusCode);
			}
