...
public class AppLinkingActivity extends ActionbarActivity implements
	...
	private void initObj() {
		...
		app = new App();
		app.setAppIcon(R.drawable.ic_eguide_bahrain);
		app.setAppId(4);
		app.setAppName(getResources().getString(
				R.string.app_eguide_bahrain_title));
		app.setAppPackage(getResources().getString(
				R.string.app_eguide_bahrain_packagename));
		appList.add(app);

		app = new App();
		app.setAppIcon(R.drawable.ic_bahrain_today);
		app.setAppId(5);
		app.setAppName(getResources().getString(
				R.string.app_bahrain_today_title));
		app.setAppPackage(getResources().getString(
				R.string.app_bahrain_today_packagename));
		appList.add(app);
		...
		app = new App();
		app.setAppIcon(R.drawable.ic_restaurant_nutrition);
		app.setAppId(9);
		app.setAppName(getResources().getString(
				R.string.app_restaurant_nutrition_title));
		app.setAppPackage(getResources().getString(
				R.string.app_restaurant_nutrition_packagename));
		appList.add(app);
